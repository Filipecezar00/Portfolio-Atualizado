...
const linkProjetos1 = document.querySelectorAll(".linkProjetos1");
...
btn_dark.addEventListener("click", () => {
  ...
  if (linkProjetos1) {
    linkProjetos1.forEach((linkProjeto1) => {
      linkProjeto1.style.color = "#f2f2f2";
    });
  }
...
btn_light.addEventListener("click", () => {
  ...
  if (linkProjetos1) {
    linkProjetos1.forEach((linkProjeto1) => {
      linkProjeto1.style.color = "#0B192C";
    });
  }
